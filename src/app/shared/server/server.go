...
func startHTTP(handlers http.Handler, s Server) {
	fmt.Println(time.Now().Format("2017-08-01 03:04:05 PM"), "Running HTTP "+httpAddress(s))
...
func startHTTPS(handlers http.Handler, s Server) {
	fmt.Println(time.Now().Format("2017-08-01 03:04:05 PM"), "Running HTTPS "+httpsAddress(s))
